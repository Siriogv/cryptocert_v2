<div class="row">
    <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4">
        <a href="dashboard-1.html" class="logo justify-content-center text-primary">
            <img src="<?php if (isset($offcdata->logo)) {
                            echo base_url() . $offcdata->logo;
                        } else { ?><?= base_url() ?>/images/logo-primary.png<?php } ?>" alt="">
        </a>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <!-- Link aggiunto per il Signup -->
                <p class="text-center my-2">Non hai un account? <a href="<?= base_url('index.php/'); ?>signin/signup">Registrati ora</a></p>
            </div>
            </form>
        </div>
    </div>
